<template>
    ...
    >
      ...
      >
       ...
       <router-link class="" :to="{ name: 'JobIndex'}">Jobs</router-link>
        </span>
            <span
                @click="isOpen = false"
                class="flex items-center p-4 hover:bg-indigo-500 hover:text-white "
        ...
        <router-link class="" :to="{ name: 'CategoryIndex'}">Categories</router-link>
            </span>
            <span
                @click="isOpen = false"
                class="flex items-center p-4 hover:bg-indigo-500 hover:text-white "
        ...
        <router-link class="" :to="{ name: 'CountryIndex'}">Countries</router-link>
            </span>
            <span
                @click="isOpen = false"
                class="flex items-center p-4 hover:bg-indigo-500 hover:text-white "
        ...
        <router-link class="" :to="{ name: 'CurrencyIndex'}">Currencies</router-link>
            </span>
            <span
                @click="isOpen = false"
                class="flex items-center p-4 hover:bg-indigo-500 hover:text-white "
        ...
        <router-link class="" :to="{ name: 'ExperienceIndex'}">Experiences</router-link>
            </span>
            <span
                @click="isOpen = false"
                class="flex items-center p-4 hover:bg-indigo-500 hover:text-white "
        ...
        <router-link class="" :to="{ name: 'TypeIndex'}">Types</router-link>
            </span>
