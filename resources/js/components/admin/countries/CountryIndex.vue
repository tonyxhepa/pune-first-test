                            ...
                            >
                                <div class="flex mr-2">
                                    <button
                                        ...
                                        @click="editCountry(cat.id)"
                                    >Edit</button>
                                    <button
                                        class="flex-1 p-1 bg-yellow-400 hover:bg-blue-600 mr-1"
                                        @click="cities(cat.id)"
                                    >Cities</button>
                                    <button
...
<script>
    ...
    export default {
        ...
        methods: {
            getCountries(baseUrl = `/api/admin/all_countries`) {
                this.tableData.draw++;
                const _this = this;
            ...
            editCountry(id) {
                this.$router.push({name: 'CountryEdit', params: {countryId: id}})
            },
            cities(id) {
                this.$router.push({name: 'CityIndex', params: {countryId: id}})
            },
            destroy(id) {
