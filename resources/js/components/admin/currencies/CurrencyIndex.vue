            ...
            <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                <div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
                    ...
                    <pagination
                        ...
                        @prev="getCurrencies(pagination.prevPageUrl)"
...
<script>
    ...
    export default {
        ...
        methods: {
            getCurrencies(baseUrl = `/api/admin/all_currencies`) {
                this.tableData.draw++;
                const _this = this;
                axios.get(baseUrl, { params: this.tableData })
                    .then(res => {
                        ...
                        if (_this.tableData.draw == data.draw) {
                            _this.currencies = data.data.data;
                            _this.configPagination(data.data.pagination);
                        }
                    })
            },
            editCurrency(id) {
                this.$router.push({name: 'CurrencyEdit', params: {countryId: id}})
            },
            destroy(id) {
