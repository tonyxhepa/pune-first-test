    ...
    <div class="container mx-auto px-4 sm:px-8">
        <div class="py-8">
            <div class="flex justify-between">
                <div></div>
                <div class=""><router-link class="p-2 bg-blue-200 rounded-lg font-bold" :to="{ name: 'CategoryCreate'}">Create</router-link></div>
            </div>
                    ...
                    <data-table :columns="columns" :sortKey="sortKey" :sortOrders="sortOrders" @sort="sortBy">
                        ...
                        >
                            ...
                            <td
                                class="px-5 py-5 border-b border-gray-200 bg-white text-sm"
                            >
                                <p class="text-gray-900 whitespace-no-wrap">{{cat.updated_at }}</p>
                            </td>
                            <td
                                class="px-5 py-5 border-b border-gray-200 bg-white text-sm"
                            >
    ...
    export default {
        ...
        data() {
            ...
            let columns = [
                ...
                { width: "auto", label: "Active", name: "active", isSortable: false },
        ...
        methods: {
            getCategories(baseUrl = `/api/admin/all_categories`) {
                this.tableData.draw++;
                const _this = this;
            ...
            editCategory(id) {
              this.$router.push({name: 'CategoryEdit', params: {categoryId: id}})
            },
            destroy(id) {
